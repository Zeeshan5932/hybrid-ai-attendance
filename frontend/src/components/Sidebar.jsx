    ...
    <aside className="fixed top-0 left-0 h-full w-64 bg-slate-900 flex flex-col z-30">
      ...
      <div className="px-6 py-5 border-b border-slate-700">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-white font-semibold text-sm leading-tight">AI Attendance</p>
            <p className="text-slate-400 text-xs capitalize">{user?.role} Portal</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-4 border-t border-slate-700">
        ...
        <button
          ...
          className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-slate-400 hover:bg-red-900/40 hover:text-red-400 text-sm transition-colors"
        >
